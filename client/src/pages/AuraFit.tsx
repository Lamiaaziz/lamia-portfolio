...
function PhoneFrame({ src, alt, label }: { src: string; alt: string; label?: string }) {
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      {label && <p className="text-xs text-center font-medium" style={{ color: "oklch(0.52 0.04 230)", fontFamily: "'DM Sans', sans-serif" }}>{label}</p>}
    </div>
  );
}
  ...
  return (
    <Layout>
      ...
      <section className="py-16" style={{ background: "oklch(0.96 0.008 270)" }}>
        <div className="container">
          <Section>
            ...
            <h2 className="text-3xl mb-8" style={{ color: "oklch(0.2 0.04 230)", fontFamily: "'DM Serif Display', serif" }}>Moodboard</h2>
            <div className="rounded-2xl overflow-hidden shadow-lg">
              <img src={IMG.moodboard} alt="AuraFit Moodboard — Black + Blue + Purple palette, Mona Sans typography" loading="lazy" decoding="async" className="w-full h-auto block" />
            </div>
          </Section>
        </div>
      </section>
        ...
        <div className="container">
          <Section>
            ...
            <p className="text-sm leading-relaxed mb-10 max-w-2xl" style={{ color: "oklch(0.42 0.04 230)", fontFamily: "'DM Sans', sans-serif" }}>
              Low-fidelity wireframes mapped the complete user flow — from onboarding and behavioral profiling through to the adaptive dashboard, workout scheduling, cart, checkout, and progress tracking.
            </p>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 justify-items-center">
              <PhoneFrame src={IMG.wireframeOnboarding} alt="Onboarding wireframe" label="Onboarding" />
              <PhoneFrame src={IMG.wireframeLogin} alt="Login wireframe" label="Login / Sign Up" />
              <PhoneFrame src={IMG.wireframeHome} alt="Home wireframe" label="Home" />
              <PhoneFrame src={IMG.wireframeCart} alt="Cart wireframe" label="Cart" />
              <PhoneFrame src={IMG.wireframeCheckout} alt="Checkout wireframe" label="Checkout" />
              <PhoneFrame src={IMG.wireframeProgress} alt="Progress wireframe" label="Progress" />
            </div>
          </Section>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container">
          <Section>
            ...
            <h2 className="text-3xl mb-4" style={{ color: "oklch(0.2 0.04 230)", fontFamily: "'DM Serif Display', serif" }}>Splash & Onboarding</h2>
            <p className="text-sm leading-relaxed mb-10 max-w-2xl" style={{ color: "oklch(0.42 0.04 230)", fontFamily: "'DM Sans', sans-serif" }}>
              The app opens with a bold splash screen, followed by three onboarding screens that introduce AuraFit's core behavioral philosophy — Consistency, Lifestyle, and Progress.
            </p>
            <div className="flex flex-wrap gap-6 justify-center">
              <PhoneFrame src={IMG.splash} alt="AuraFit Splash Screen" label="Splash Screen" />
              <PhoneFrame src={IMG.onboarding1} alt="Onboarding 1 — Consistency Over Intensity" label="Onboarding 1" />
              <PhoneFrame src={IMG.onboarding2} alt="Onboarding 2 — Built Around Your Lifestyle" label="Onboarding 2" />
              <PhoneFrame src={IMG.onboarding3} alt="Onboarding 3 — Progress That Adjusts With You" label="Onboarding 3" />
            </div>
          </Section>
        </div>
      </section>
      ...
      <section className="py-16" style={{ background: "oklch(0.96 0.008 270)" }}>
        <div className="container">
          <Section>
            <h2 className="text-3xl mb-4" style={{ color: "oklch(0.2 0.04 230)", fontFamily: "'DM Serif Display', serif" }}>Welcome & Account Setup</h2>
            <p className="text-sm leading-relaxed mb-10 max-w-2xl" style={{ color: "oklch(0.42 0.04 230)", fontFamily: "'DM Sans', sans-serif" }}>
              After onboarding, users land on the Welcome screen and complete a 3-step setup: creating their account, answering a quick lifestyle quiz to personalize their plan, and receiving their assigned training mode.
            </p>
            <div className="flex flex-wrap gap-6 justify-center">
              <PhoneFrame src={IMG.welcome} alt="Welcome Screen" label="Welcome" />
              <PhoneFrame src={IMG.step1} alt="Step 1 — Sign Up" label="Step 1 — Sign Up" />
              <PhoneFrame src={IMG.step2} alt="Step 2 — Personalization Quiz" label="Step 2 — Personalize" />
              <PhoneFrame src={IMG.step3} alt="Step 3 — Mode Assignment" label="Step 3 — Your Mode" />
            </div>
          </Section>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container">
          <Section>
            <h2 className="text-3xl mb-4" style={{ color: "oklch(0.2 0.04 230)", fontFamily: "'DM Serif Display', serif" }}>Dashboard & Progress Tracking</h2>
            <p className="text-sm leading-relaxed mb-10 max-w-2xl" style={{ color: "oklch(0.42 0.04 230)", fontFamily: "'DM Sans', sans-serif" }}>
              The main dashboard adapts to the user's assigned mode (e.g. Busy Week Mode), showing consistency scores, training rhythm, and recovery insights. The progress screen provides detailed weekly analytics with behavioural metrics and AI-powered recommendations.
            </p>
            <div className="flex flex-wrap gap-8 justify-center">
              <PhoneFrame src={IMG.dashboard} alt="AuraFit Dashboard — Hi, Salma, Busy Week Mode" label="Dashboard" />
              <PhoneFrame src={IMG.progress} alt="Weekly Progress — Consistency Score, Behaviour Metrics" label="Weekly Progress" />
            </div>
          </Section>
        </div>
      </section>
            ...
            <div className="rounded-2xl p-8" style={{ background: "oklch(0.45 0.12 270)" }}>
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  ...
                  <h3 className="text-xl font-semibold mb-1" style={{ color: "oklch(0.98 0.005 230)", fontFamily: "'DM Sans', sans-serif" }}>Salma, 28</h3>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {["Stay consistent with workouts", "Manage fitness around a busy schedule", "Track progress without overwhelm"].map((g) => (
          ...
          <Section>
            <div className="rounded-2xl p-10 lg:p-16 text-center relative overflow-hidden">
              ...
              <h2 className="text-3xl lg:text-4xl mb-6 relative z-10" style={{ color: "oklch(0.2 0.04 230)", fontFamily: "'DM Serif Display', serif" }}>
                "AuraFit shifts fitness from motivation-driven routines to a behaviour-guided system."
              </h2>
